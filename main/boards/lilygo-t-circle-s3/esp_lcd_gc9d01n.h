 ...
 * */
typedef struct {
    const gc9d01n_lcd_init_cmd_t *init_cmds;     /* !< Con trỏ tới mảng lệnh khởi tạo. Đặt thành NULL nếu sử dụng các lệnh mặc định.
...
/* *
 * @brief Tạo bảng điều khiển LCD cho model GC9D01N
 *
