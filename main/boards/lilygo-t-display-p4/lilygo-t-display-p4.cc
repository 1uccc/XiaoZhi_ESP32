...
#error "unknown macro definition, please select the correct macro definition."
    ...
    void InitializeXl9535() {
        ...
        // Khi chuyển đổi điện áp 3,3v, trước tiên phải tắt nguồn GPS.
        ...
        // Khi chuyển đổi điện áp 3,3v, trước tiên phải tắt nguồn ESP32C6.
    ...
    void InitializeLCD() {
        ...
        esp_lcd_dbi_io_config_t dbi_io_config = {
            .virtual_channel = 0,
            .lcd_cmd_bits = 8,   // theo thông số LCD
            .lcd_param_bits = 8, // theo thông số LCD
        };
        ...
        esp_lcd_dpi_panel_config_t dpi_config = {
            ...
            .flags = {
                .use_dma2d = true, // sử dụng DMA2D để sao chép bộ đệm vẽ vào bộ đệm khung
            }
        };
...
#error "unknown macro definition, please select the correct macro definition."
        ...
        if(touch_lock_flag == false){
            ...
            if (!waiting_for_second_tap) {
                ...
                // Nhấp chuột thứ hai để kiểm tra khoảng thời gian
                // Nhấp đúp chuột hoàn thành trong vòng 500ms
