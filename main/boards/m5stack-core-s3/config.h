...
// Cấu hình bo mạch M5Stack CoreS3
...
#define CAMERA_PIN_XCLK  GPIO_NUM_NC // Đồng hồ pixel (cố định bằng đầu vào bộ dao động tinh thể bên ngoài 20 MHz)
#define CAMERA_PIN_SIOD GPIO_NUM_NC  // Đồng hồ nối tiếp Sử dụng cổng I2C hiện có
#define CAMERA_PIN_SIOC GPIO_NUM_NC  // Đồng hồ nối tiếp Sử dụng cổng I2C hiện có
