...
public:
    GC9107Display(esp_lcd_panel_io_handle_t panel_io, esp_lcd_panel_handle_t panel,
        ...
        // Chỉ cần ghi đè các kiểu liên quan đến màu sắc
        auto screen = lv_disp_get_scr_act(lv_disp_get_default());
        lv_obj_set_style_text_color(screen, lv_color_black(), 0);

        // Đặt màu nền vùng chứa
        lv_obj_set_style_bg_color(container_, lv_color_black(), 0);

        // Đặt màu nền và màu văn bản của thanh trạng thái
        ...
        // Đặt màu nền và màu chữ của vùng nội dung
...
private:
    ...
    void InitializeGc9107Display(){
        ...
        // Khởi tạo chip điều khiển LCD GC9107
