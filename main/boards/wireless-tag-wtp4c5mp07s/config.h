...
#define LCD_MIPI_DSI_LANE_NUM           (2)    // 2 làn dữ liệu
...
// Cấu hình thẻ SD (bị tắt theo mặc định)
// Kích hoạt một trong các mục sau bằng cách đặt thành 1 và đặt các chân tương ứng.
// Lưu ý: SDMMC có thể xung đột với SDIO được lưu trữ trên ESP. Nếu sử dụng ESP-Hosted qua SDIO,
// thích chế độ SDSPI cho thẻ SD hoặc tắt SDIO được lưu trữ.

// Chế độ SDMMC 1 bit/4 bit
#ifndef SDCARD_SDMMC_ENABLED
#define SDCARD_SDMMC_ENABLED            0
#endif
// Độ rộng bus SDMMC: đặt thành 1 hoặc 4
#ifndef SDCARD_SDMMC_BUS_WIDTH
// Sử dụng độ rộng bus 4 bit khi bật SDMMC
#define SDCARD_SDMMC_BUS_WIDTH          4
#endif
// Gán chân SDMMC (được đặt thành chân thực tế khi bật SDMMC)
