...
private:
    ...
    void InitializeNv3023Display() {
        ...
        nv3023_vendor_config_t vendor_config = {  // Bỏ ghi chú những dòng này nếu sử dụng lệnh khởi tạo tùy chỉnh
...
public:
    XINGZHI_CUBE_0_85TFT_ML307(): Ml307Board(ML307_TX_PIN, ML307_RX_PIN),
        ...
        Initializegpio21_45(); // Ban đầu, kéo chân 21 lên cao để đảm bảo mô-đun 4g hoạt động bình thường
