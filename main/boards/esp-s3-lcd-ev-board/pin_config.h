...
// Thông tin tham khảo về bo mạch và màn hình phát triển
...
// Nếu bảng phát triển là V1.4 IO được định nghĩa là
...
#endif
// Nếu bảng phát triển là V1.5 IO được định nghĩa là
