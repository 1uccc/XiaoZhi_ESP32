...
private:
    ...
    void InitializePowerSaveTimer() {
        // Hẹn giờ, điều chỉnh máy về chế độ modem-sleep và độ sáng màn hình
        ...
        power_save_timer_->OnExitSleepMode([this]() {
            ...
            esp_wifi_set_ps(WIFI_PS_NONE);  // Tắt Wi-Fi để tiết kiệm điện và trở lại bình thường
            // Esp_lcd_panel_disp_on_off(panel_, true); //Mở lại màn hình
        });
        power_save_timer_->OnShutdownRequest([this]() {
            ESP_LOGI(TAG, "Shutting down display");            
            GetBacklight()->SetBrightness(1);
            // Esp_lcd_panel_disp_on_off(panel_, false); //Tắt hiển thị
            // power_save_timer_->SetEnabled(false); // Tắt bộ đếm thời gian để tránh trùng lặp
...
public:
    SurferC3114TFT() : boot_button_(BOOT_BUTTON_GPIO) {
        ...
        // Sử dụng chân VDD SPI của ESP32C3 làm cổng GPIO bình thường
