...
// Khởi tạo ili9341 bằng cmd tùy chỉnh
...
private:
    ...
    void InitializePowerManager() {
        // PowerManager cần sử dụng lại tay cầm ADC của nút, vì vậy nó được gọi sau Khởi tạoButtons
        // Chuyển con trỏ điều khiển ADC của nút vào và để PowerManager sử dụng lại nó.
    ...
    void InitializeTca9554() {
        ...
        // Định cấu hình IO0-IO3 làm chế độ đầu ra
    ...
    void EnableLcdCs() {
        if(io_expander_ != NULL) {
            esp_io_expander_set_level(io_expander_, IO_EXPANDER_PIN_NUM_3, 0);// Đặt CS LCD ở mức thấp
        }
    }
    ...
    void InitializeButtons() {
        ...
        adc_cfg.adc_channel = ADC_CHANNEL_4; // Kênh ADC1 0 là GPIO5
#if ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(5, 0, 0)
    ...
    void InitializeCamera() {
         // ESP32-S3 sử dụng thành phần Esp_Camera
        camera_config_t camera_config = {
            .pin_pwdn = CAMERA_PIN_PWDN,
            .pin_reset = CAMERA_PIN_RESET,
            .pin_xclk = CAMERA_PIN_XCLK,
            .pin_sccb_sda = -1, // Sử dụng I2C khởi tạo
            .pin_sccb_scl = -1,
...
public:
    Esp32S3Korvo2V3Board() : boot_button_(BOOT_BUTTON_GPIO) {
        ...
        InitializeCamera();
        InitializeSpi();
        InitializeButtons();  // Khởi tạo nút trước (tạo tay cầm ADC1)
        InitializePowerManager();  // Sau khi khởi tạo PowerManager (sử dụng lại tay cầm ADC1)
