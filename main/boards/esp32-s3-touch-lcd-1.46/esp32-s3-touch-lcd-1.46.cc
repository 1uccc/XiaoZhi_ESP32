...
// Thêm lớp hiển thị mới trước lớp waveshare_lcd_1_46
...
public:
    static void rounder_event_cb(lv_event_t * e) {
        ...
        area->x1 = (x1 >> 2) << 2;          // làm tròn điểm bắt đầu tọa độ xuống số 4M gần nhất
        area->x2 = ((x2 >> 2) << 2) + 3;    // làm tròn điểm cuối tọa độ lên số 4N+3 gần nhất
    }
