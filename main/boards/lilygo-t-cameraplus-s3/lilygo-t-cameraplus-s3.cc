...
public:
    ...
    Pmic(i2c_master_bus_handle_t i2c_bus, uint8_t addr) : Sy6970(i2c_bus, addr) {
        ...
        WriteReg(0x00, 0B00001000); // Tắt mã pin ILIM
        WriteReg(0x02, 0B11011101); // Kích hoạt chức năng đo ADC
        WriteReg(0x07, 0B10001101); // Vô hiệu hóa chức năng cấp dữ liệu hẹn giờ của cơ quan giám sát
    }
};
