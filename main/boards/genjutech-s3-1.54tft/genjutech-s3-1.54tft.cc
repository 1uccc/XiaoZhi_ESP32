...
private:
    ...
    void InitializePowerSaveTimer() {
        // Khi tham số đầu tiên không phải là -1, việc chuyển sang chế độ ngủ sẽ tắt đầu vào âm thanh
    ...
    void InitializeButtons() {
        ...
        // Ứng dụng::GetInstance().StartListening();
        // });
        // boot_button_.OnPressUp([this]() {
        // Ứng dụng::GetInstance().StopListening();
        // });
