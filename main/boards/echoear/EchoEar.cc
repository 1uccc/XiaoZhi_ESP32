...
public:
    ...
    void Printcharge()
    {
        ...
        // Sử dụng các biến để tránh cảnh báo (có thể bị xóa nếu triển khai thực tế sử dụng chúng)
        (void)voltage;
        (void)current;
    }
...
private:
    ...
    esp_lcd_touch_handle_t tp;   // Tay cầm cảm ứng LCD
