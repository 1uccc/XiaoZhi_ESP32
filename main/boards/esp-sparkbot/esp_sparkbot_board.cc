...
public:
    ...
    void EnableOutput(bool enable) override {
        ...
        if (enable) {
           ...
           // Không cần làm gì vì xung đột hiển thị io và PA io
        }
    }
};
...
private:
    ...
    void InitializeCamera() {
        ...
        // Vì một số bản sao sử dụng thiết kế máy ảnh cố định nên tính năng lật được bật theo mặc định.
