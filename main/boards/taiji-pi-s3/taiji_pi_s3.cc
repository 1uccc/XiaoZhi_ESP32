...
private:
    ...
    void BspLcdBlSet(int brightness_percent)
    {
        ...
        uint32_t duty_cycle = (1023 * brightness_percent) / 100; // Độ phân giải LEDC được đặt thành 10 bit, do đó: 100% = 1023
    ...
    void Initializest77916Display() {
        ...
        st77916_vendor_config_t vendor_config = {
            .init_cmds = lcd_init_cmds, // Nếu sử dụng lệnh khởi tạo tùy chỉnh, hãy bỏ ghi chú những dòng này
