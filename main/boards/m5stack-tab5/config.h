...
#define AUDIO_CODEC_PA_PIN       GPIO_NUM_NC // Kiểm soát PI4IOE
...
#define TOUCH_INT_GPIO  GPIO_NUM_23  // Chạm vào gián đoạn
...
const ili9881c_lcd_init_cmd_t tab5_lcd_ili9881c_specific_init_code_default[] = {
    ...
    {0xB7, (uint8_t[]){0x03}, 1, 0},  // đặt 2 làn
    /* *** CMD_Trang 3 *** */
...
// Các lệnh khởi tạo cụ thể của nhà cung cấp ST7123
