...
private:
    ...
    // thêm hỗ trợ màn hình LCD ev board
    ...
    void InitializeRGB_GC9503V_Display() {
        ...
        esp_lcd_rgb_panel_config_t rgb_config = {
            ...
            .data_width = 16, // RGB565 ở chế độ song song, do đó có chiều rộng 16 bit
            .bits_per_pixel = 16,
            ...
            .flags= {
                .fb_in_psram = true, // phân bổ bộ đệm khung trong PSRAM
            }
        };
    ...
    void InitializeCodecI2c() {
        ...
        ESP_ERROR_CHECK(i2c_new_master_bus(&i2c_bus_cfg, &i2c_bus_));
         ...
         // thêm hỗ trợ bo mạch ev lcd amp
        // Khởi tạo cổng io mở rộng
        esp_io_expander_new_i2c_tca9554(i2c_bus_, 0x20, &expander);
        /* Thiết lập chân khuếch đại công suất, đặt mặc định để bật */
...
public:
    ...
    // Thêm trạng thái hiển thị đèn màu. Nếu độ sáng quá tối, bạn có thể thay đổi giá trị độ sáng mặc định DEFAULT_BRIGHTNESS trong sigle_led.cc của led.
