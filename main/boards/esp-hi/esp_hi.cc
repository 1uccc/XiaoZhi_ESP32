...
private:
    ...
    void InitializeButtons()
    {
        ...
        static int gesture_state = 0;  // 0: init, 1: chờ khoảng thời gian dài thứ hai, 2: chờ dao động
