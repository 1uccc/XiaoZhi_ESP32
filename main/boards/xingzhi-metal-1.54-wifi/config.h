...
#define Power_Control GPIO_NUM_48               // Chân điều khiển nguồn
#define Power_Dec GPIO_NUM_47                   // Pin phát hiện nút nguồn
#define POWER_CBS_ADC_UNIT ADC_UNIT_1           // adc phát hiện đơn vị công cộng GPIO1
#define POWER_USBIN_ADC_CHANNEL ADC_CHANNEL_0   // Phát hiện xem USB có được cắm vào GPIO1 hay không
#define POWER_BATTERY_ADC_CHANNEL ADC_CHANNEL_6 // Phát hiện năng lượng pin GPIO7
