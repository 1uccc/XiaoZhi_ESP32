...
// Định nghĩa các chân liên quan đến phát hiện nguồn
#define BATTERY_ADC_PIN         GPIO_NUM_1  // Chân ADC phát hiện điện áp pin
#define BATTERY_CHARGING_PIN    GPIO_NUM_41 // Pin phát hiện trạng thái sạc
